...
// getAdminUserID returns the verified caller. It reports failure rather than
...
func (h *AdminComplianceHandler) getAdminUserID(c *gin.Context) (uuid.UUID, bool) {
